  ...
  if (mixedRef !== null && typeof mixedRef !== 'function' && typeof mixedRef !== 'object') {
    if (element._owner) {
      ...
      if (owner) {
        ...
        if (ownerFiber.tag !== WorkTag.ClassComponent) {
          throw new Error(
...
function ChildReconciler(shouldTrackSideEffects: boolean) {
  ...
  function updatePortal(
    ...
    console.error('updatePortal 未实现');
    // if (
    //   current === null ||
  ...
  /**
   * read: 这里估计是实现 <></> 这种写法的 React element
   * @param returnFiber
   * @param current
   * @param fragment
   * @param lanes
    ...
    if (typeof newChild === 'object' && newChild !== null) {
      switch (newChild.$$typeof) {
        ...
        case REACT_PORTAL_TYPE: {
          ...
          // created.return = returnFiber;
          // return created;
          console.error('createChild -> REACT_PORTAL_TYPE 未实现');
          return null;
        }
    ...
    if (typeof newChild === 'object' && newChild !== null) {
      switch (newChild.$$typeof) {
        ...
        case REACT_PORTAL_TYPE: {
          ...
          //   return null;
          // }
          console.error(' updateSlot -> REACT_PORTAL_TYPE 待实现');
          return null;
        }
        case REACT_LAZY_TYPE: {
          const payload = newChild._payload;
  ...
  function reconcileChildFibers(
    ...
    console.log('协调ChildFiber，主要是对 fiber 节点进行增删改');
    ...
    if (typeof newChild === 'object' && newChild !== null) {
      switch (newChild.$$typeof) {
        ...
        case REACT_PORTAL_TYPE:
          ...
          // );
          console.error('开始协调 REACT_PORTAL_TYPE 方法未实现');
          return null;
        case REACT_LAZY_TYPE:
          // const payload = newChild._payload;
          // const init = newChild._init;
          ...
          console.error('开始协调 REACT_LAZY_TYPE 方法未实现');
      ...
      if (getIteratorFn(newChild)) {
        console.log('什么时候会走到这里呢？getIteratorFn && -> reconcileChildrenIterator');
